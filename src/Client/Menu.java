...
public class Menu extends JFrame implements WindowListener, ActionListener, ChangeListener, ItemListener {
    ...
    public Menu(Comms s) {
        ...
        String time[] = server.getFilmDateTimes((String) CBFilmDropdown.getModel().getSelectedItem(), 
                (String) CBDateDropdown.getModel().getSelectedItem());
        ...
        String seats[] = server.getFilmDateTimeSeats((String) CBFilmDropdown.getModel().getSelectedItem(), 
                (String) CBDateDropdown.getModel().getSelectedItem(), 
                (String) CBTimeDropdown.getModel().getSelectedItem());
